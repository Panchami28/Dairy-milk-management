                    ...
                    <ul class="top-icons-agileits-w3layouts float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu drop-3">
                                ...
                                <a class="dropdown-item" href="a1logouts">Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
<form method="post" action="/editqry" style="width: 45%;">
      ...
      <label>User id</label>
      <input type="text" name="uid" class="form-control" value="{{$value->userid}}"><br>
      <label>Address</label>
      <input type="text" name="ad" class="form-control" value="{{$value->ad}}"><br>
      <label>email</label>
      <input type="text" name="em" class="form-control" value="{{$value->email}}"><br>
       <label>password</label>
      <input type="text" name="pw" class="form-control" value="{{$value->password}}"><br>

      @endforeach
      <input type="submit" name="add" class="btn btn-info" value="Edit">
